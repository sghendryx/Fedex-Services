"""
python-fedex_wrapper API Documentation
==============================
The python-fedex_wrapper module is a light wrapper around Fedex's Web Services SOAP API.
...
What python-fedex_wrapper is
--------------------
    - A light wrapper around Fedex Web Services SOAP API.
    - Simple and easy to use.
    - Minimal by design.

What python-fedex_wrapper is not
------------------------
    - An abstraction layer. python-fedex_wrapper only assembles the needed SOAP calls
...
----------------------
python-fedex_wrapper was created for use with various internal projects over the years.
...
Getting Started
---------------
The best place to get started is by viewing the scripts in the 'scripts'
...
what you'll be able to do with python-fedex_wrapper.
