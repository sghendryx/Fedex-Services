...
class GeneralSudsPlugin(MessagePlugin):
    ...
    def __init__(self, **kwargs):
        ...
        self.request_logger = logging.getLogger('fedex_wrapper.request')
        self.response_logger = logging.getLogger('fedex_wrapper.response')
        self.kwargs = kwargs
...
class FedexBaseService(object):
    ...
    def __init__(self, config_obj, wsdl_name, *args, **kwargs):
        ...
        self.logger = logging.getLogger('fedex_wrapper')
        """@ivar: Python logger instance with name 'fedex_wrapper'."""
